...
(define-key evil-window-map ";" 'evil-window-left)
...
(define-key evil-window-map "q" 'evil-window-right)
...
(define-key evil-motion-state-map (kbd "M-;") 'evil-window-left)
(define-key evil-motion-state-map (kbd "M-q") 'evil-window-right)
...
(define-key evil-motion-state-map ";" 'evil-backward-char)
(define-key evil-motion-state-map "H" 'evil-window-top)
(define-key evil-motion-state-map "j" 'evil-next-line)
(define-key evil-motion-state-map "k" 'evil-previous-line)
(define-key evil-motion-state-map "q" 'evil-forward-char)
